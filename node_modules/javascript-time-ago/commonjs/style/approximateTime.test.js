...
(0, _mocha.describe)('style/approximate-time', function () {
  (0, _mocha.it)('should format relative time (English)', function () {
  ...
  (0, _mocha.it)('should format relative time (Russian)', function () {
...
function approximateScaleStepsTest(labels, timeAgo) {
  ...
  while (i < approximateScaleSteps.length) {
    for (var _iterator = _createForOfIteratorHelperLoose(approximateScaleSteps[i]), _step; !(_step = _iterator()).done;) {
      ...
      (0, _chai.expect)(elapsed(time)).to.equal(labels[i]);
    }
    i++;
  }
}
